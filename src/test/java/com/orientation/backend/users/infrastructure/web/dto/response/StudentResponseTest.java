...
class StudentResponseTest {
    ...
    private Student createFullStudent() {
        return Student.builder()
                ...
                .howDidYouKnowUs(DiscoveryOption.WEBSITE)
                .howDidYouContactUs(ContactOption.EMAIL)
    ...
    private Student createMinimalStudent() {
        return Student.builder()
                ...
                .fullName(FullName.of("Maria", "Martínez"))
    ...
    void shouldMapAllFieldsFromDomain() {
        ...
        assertEquals("García", response.surname());
    ...
    void shouldMapNullFieldsFromDomain() {
        ...
        assertEquals("Martínez", response.surname());
